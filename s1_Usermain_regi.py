...
if __name__=="__main__":
    imgname = 'IM42079-BNST-A_dapi4Regi/'#数据批次名称
    ...
    framenum=[1,7]##输入一个列表，代表区域数目，比如[1,10]代表计算1到9的区域
    rnum=6#输入轮次数
    mulfra_mulr_1r_regist(framenum,rnum,inbase,outbase,[],hmode,add='.tif',dis=155,aug=False)